...
export const nonSendedColumns = excludeColumns(
  'reviewedAt',
  'releasedAt',
  'expectedBillingAt',
  'billingAt',
...
export const nonReviewedColumns = excludeColumns(
  'releasedAt',
  'expectedBillingAt',
  'billingAt',
  'invoiceNumber',
...
export const nonReleasedColumns = excludeColumns(
  'expectedBillingAt',
  'billingAt',
  'invoiceNumber',
  'freeOnBoardAt',
...
export const nonExpectedBillingColumns = excludeColumns(
  'billingAt',
  'invoiceNumber',
  'freeOnBoardAt',
  'schedulingAt'
...
export const nonBilledColumns = excludeColumns('freeOnBoardAt', 'schedulingAt')

export const nonFreeOnBoardColumns = excludeColumns('schedulingAt')

export const nonSchedulingColumns = excludeColumns()

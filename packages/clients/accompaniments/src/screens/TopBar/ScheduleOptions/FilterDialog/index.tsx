...
import { ScheduleFilterHandles } from './types'

const ScheduleFilterComponent: React.ForwardRefRenderFunction<ScheduleFilterHandles> = (
  _,
  ref
) => {
  ...
  useImperativeHandle<{}, ScheduleFilterHandles>(ref, () => ({ open, close }), [
    open,
    close
  ])
...
export * from './types'
export const ScheduleFilter = forwardRef(ScheduleFilterComponent)

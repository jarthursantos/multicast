# Migration `20201002193646-add-sended-and-reviewed-columns-in-accompaniment`

This migration has been generated by Arthur Santos at 10/2/2020, 4:36:47 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."accompaniments" ADD COLUMN "sendedAt" timestamp(3)   ,
ADD COLUMN "reviwedAt" timestamp(3)   
```
...
migration 20200912115010-initialization..20201002193646-add-sended-and-reviewed-columns-in-accompaniment
--- datamodel.dml
+++ datamodel.dml
@@ -1,276 +1,278 @@
-datasource db {

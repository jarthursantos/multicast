...
import { FindAccompanimentProductsController } from './FindAccompanimentProductsController'
...
const findAccompanimentProductsUseCase = new FindAccompanimentProductsUseCase(
  prismaAccompanimentsRepository,
  winThorAccompanimentProductsRepository
)

const findAccompanimentProductsController = new FindAccompanimentProductsController(
  findAccompanimentProductsUseCase
)

export { findAccompanimentProductsUseCase, findAccompanimentProductsController }

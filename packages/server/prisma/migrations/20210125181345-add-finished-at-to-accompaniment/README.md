# Migration `20210125181345-add-finished-at-to-accompaniment`

This migration has been generated by Arthur Santos at 1/25/2021, 3:13:45 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."accompaniments" ADD COLUMN "finishedAt" timestamp(3)   

ALTER TABLE "public"."schedules" DROP COLUMN "finishedAt"
```
...
migration 20210125180736-add-finish-to-schedule..20210125181345-add-finished-at-to-accompaniment
--- datamodel.dml
+++ datamodel.dml
@@ -1,292 +1,292 @@
-datasource db {
